...
const translations = {
    fr: {
        ...
        'tutorial-1-title': 'Recitation',
        'tutorial-1-desc': 'Marquage des erreurs de récitation',
        'tutorial-2-title': 'Repetition',
        'tutorial-2-desc': 'Entraînement à la répétition',
        'tutorial-3-title': 'Objectives',
        'tutorial-3-desc': 'Planification des objectifs',
        'tutorial-4-title': 'Revision',
        'tutorial-4-desc': 'Révision du Coran',
        'tutorial-5-title': 'Recordings',
        'tutorial-5-desc': 'Enregistrements audio',
        'tutorial-6-title': 'Statistics',
        'tutorial-6-desc': 'Suivi des progrès et statistiques',
    ...
    en: {
        ...
        'tutorial-1-title': 'Recitation',
        'tutorial-1-desc': 'Recitation error marking',
        'tutorial-2-title': 'Repetition',
        'tutorial-2-desc': 'Repetition training',
        'tutorial-3-title': 'Objectives',
        'tutorial-3-desc': 'Objectives planning',
        'tutorial-4-title': 'Revision',
        'tutorial-4-desc': 'Quran review',
        'tutorial-5-title': 'Recordings',
        'tutorial-5-desc': 'Audio recordings',
        'tutorial-6-title': 'Statistics',
        'tutorial-6-desc': 'Statistics progress',
    ...
    ar: {
        ...
        'tutorial-1-title': 'التلاوة',
        'tutorial-1-desc': 'تحديد أخطاء التلاوة',
        'tutorial-2-title': 'التكرار',
        'tutorial-2-desc': 'تدريب التكرار',
        'tutorial-3-title': 'الأهداف',
        'tutorial-3-desc': 'تخطيط الأهداف',
        'tutorial-4-title': 'المراجعة',
        'tutorial-4-desc': 'مراجعة القرآن',
        'tutorial-5-title': 'التسجيلات',
        'tutorial-5-desc': 'التسجيلات الصوتية',
        'tutorial-6-title': 'الإحصائيات',
        'tutorial-6-desc': 'تقدم الإحصائيات',
